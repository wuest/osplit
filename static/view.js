...
var $author$project$ViewOnly$CurrentCategoryView = function (a) {
	return {$: 'CurrentCategoryView', a: a};
};
...
var $author$project$ViewOnly$init = function (url) {
	return _Utils_Tuple2(
		{
			categoryList: _List_Nil,
			configStore: $elm$core$Dict$empty,
			gameList: _List_Nil,
			maxSegmentsShown: 10,
			multiCategoryDisplay: $author$project$ViewOnly$CurrentCategoryView(0),
			socket: $elm$core$Maybe$Nothing,
			timer: $author$project$Timer$empty
		},
		$author$project$Websocket$open(url));
};
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$ViewOnly$SocketNotOpened = function (a) {
	return {$: 'SocketNotOpened', a: a};
};
var $author$project$ViewOnly$SocketOpened = function (a) {
	return {$: 'SocketOpened', a: a};
};
var $author$project$ViewOnly$SocketReceived = function (a) {
	return {$: 'SocketReceived', a: a};
};
var $author$project$ViewOnly$Tick = function (a) {
	return {$: 'Tick', a: a};
};
...
var $author$project$ViewOnly$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				A3($author$project$Websocket$subscriptions, $author$project$ViewOnly$SocketOpened, $author$project$ViewOnly$SocketNotOpened, $author$project$ViewOnly$SocketReceived),
				A2($elm$time$Time$every, 4, $author$project$ViewOnly$Tick)
			]));
};
...
var $author$project$ViewOnly$newClientJSON = $elm$json$Json$Encode$object(
	_List_fromArray(
		[
			_Utils_Tuple2(
			'tag',
...
var $author$project$ViewOnly$FetchedCategoryList = function (a) {
...
var $author$project$ViewOnly$checkTag_ = F3(
...
var $author$project$ViewOnly$checkTag = F2(
	function (target, da) {
		return A3(
			$author$project$ViewOnly$checkTag_,
			A2(
...
var $author$project$ViewOnly$categoryListDecoder = A2(
	$author$project$ViewOnly$checkTag,
	'CategoryList',
	A2(
		$elm$json$Json$Decode$map,
		$author$project$ViewOnly$FetchedCategoryList,
		A2(
			$elm$json$Json$Decode$at,
			_List_fromArray(
				['data', 'contents']),
...
var $author$project$ViewOnly$ClientStateRequest = function (a) {
	return {$: 'ClientStateRequest', a: a};
};
var $author$project$ViewOnly$clientStateRequestDecoder = A2(
	$author$project$ViewOnly$checkTag,
	'ClientStateRequest',
	A2(
		$elm$json$Json$Decode$map,
		$author$project$ViewOnly$ClientStateRequest,
		A2(
			$elm$json$Json$Decode$at,
			_List_fromArray(
				['data', 'contents']),
			$elm$json$Json$Decode$int)));
var $author$project$ViewOnly$UnloadSplits = {$: 'UnloadSplits'};
var $author$project$ViewOnly$closeSplitsDecoder = A2(
	$author$project$ViewOnly$checkTag,
	'CloseSplits',
	A2(
		$elm$json$Json$Decode$map,
		function (_v0) {
			return $author$project$ViewOnly$UnloadSplits;
		},
		A2(
			$elm$json$Json$Decode$at,
			_List_fromArray(
				['data', 'tag']),
			$elm$json$Json$Decode$string)));
var $author$project$ViewOnly$ConfigStoreSet = F2(
	function (a, b) {
		return {$: 'ConfigStoreSet', a: a, b: b};
	});
var $elm$json$Json$Decode$index = _Json_decodeIndex;
var $author$project$ViewOnly$configStoreDecoder = A2(
	$author$project$ViewOnly$checkTag,
	'ConfigStore',
	A3(
		$elm$json$Json$Decode$map2,
		$author$project$ViewOnly$ConfigStoreSet,
		A2(
			$elm$json$Json$Decode$at,
			_List_fromArray(
				['data', 'contents']),
...
var $author$project$ViewOnly$FetchedGameList = function (a) {
...
var $author$project$ViewOnly$gameListDecoder = A2(
	$author$project$ViewOnly$checkTag,
	'GameList',
	A2(
		$elm$json$Json$Decode$map,
		$author$project$ViewOnly$FetchedGameList,
		A2(
			$elm$json$Json$Decode$at,
			_List_fromArray(
				['data', 'contents']),
			$elm$json$Json$Decode$list(
				A5(
					...
					A2(
						...
						$elm$json$Json$Decode$int))))));
var $author$project$ViewOnly$FetchedSplits = function (a) {
...
var $author$project$ViewOnly$categoryDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Timer$Category,
	A2(
		$elm$json$Json$Decode$at,
	...
	A2(
		...
		$elm$json$Json$Decode$int));
var $author$project$ViewOnly$gameDecoder = A5(
	$elm$json$Json$Decode$map4,
	$author$project$Timer$Game,
	A2(
		$elm$json$Json$Decode$at,
...
var $author$project$ViewOnly$splitSetDecoder = A2(
	$elm$json$Json$Decode$map,
		...
		A2(
			...
			A8(
				...
				A2(
					...
					'segmentWorst',
					$elm$json$Json$Decode$maybe($elm$json$Json$Decode$int))))));
var $author$project$ViewOnly$singleCategorySpecDecoder_ = A4(
	$elm$json$Json$Decode$map3,
	A2($author$project$Timer$Run, $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing),
	$author$project$ViewOnly$gameDecoder,
	$author$project$ViewOnly$categoryDecoder,
	A2(
		$elm$json$Json$Decode$at,
		_List_fromArray(
			['splitSetSegments']),
		$author$project$ViewOnly$splitSetDecoder));
var $author$project$ViewOnly$multiCategorySpecDecoder = A3(
	$elm$json$Json$Decode$map2,
	...
	A2(
		...
		_List_fromArray(
			['multiCategoryGames']),
		$elm$json$Json$Decode$list($author$project$ViewOnly$singleCategorySpecDecoder_)));
var $author$project$Timer$SingleCategorySpec = function (a) {
	return {$: 'SingleCategorySpec', a: a};
};
var $author$project$ViewOnly$singleCategorySpecDecoder = A2($elm$json$Json$Decode$map, $author$project$Timer$SingleCategorySpec, $author$project$ViewOnly$singleCategorySpecDecoder_);
var $author$project$ViewOnly$runSpecDecoder = $elm$json$Json$Decode$oneOf(
	_List_fromArray(
		[$author$project$ViewOnly$singleCategorySpecDecoder, $author$project$ViewOnly$multiCategorySpecDecoder]));
var $author$project$ViewOnly$multiCategoryDecoder = A2(
	$author$project$ViewOnly$checkTag,
	'MultiCategoryRefresh',
	A2(
		$elm$json$Json$Decode$map,
		$author$project$ViewOnly$FetchedSplits,
		A3(
			$elm$json$Json$Decode$map2,
			F2(
				function (t, cs) {
			...
			A2(
				...
				_List_fromArray(
					['data', 'contents']),
				$author$project$ViewOnly$runSpecDecoder))));
var $author$project$ViewOnly$RemoteReset = {$: 'RemoteReset'};
var $author$project$ViewOnly$SplitsControl = function (a) {
	return {$: 'SplitsControl', a: a};
};
var $author$project$ViewOnly$checkTag2 = F2(
	function (target, da) {
		return A3(
			$author$project$ViewOnly$checkTag_,
			A2(
...
var $author$project$ViewOnly$decodeRemoteReset = A2(
	$author$project$ViewOnly$checkTag,
	'RemoteControl',
	A2(
		$author$project$ViewOnly$checkTag2,
		'RemoteReset',
		A2(
			$elm$json$Json$Decode$map,
			$author$project$ViewOnly$SplitsControl,
			$elm$json$Json$Decode$succeed($author$project$ViewOnly$RemoteReset))));
var $author$project$ViewOnly$RemoteSkip = {$: 'RemoteSkip'};
var $author$project$ViewOnly$decodeRemoteSkip = A2(
	$author$project$ViewOnly$checkTag,
	'RemoteControl',
	A2(
		$author$project$ViewOnly$checkTag2,
		...
		A2(
			$elm$json$Json$Decode$map,
			$author$project$ViewOnly$SplitsControl,
			$elm$json$Json$Decode$succeed($author$project$ViewOnly$RemoteSkip))));
var $author$project$ViewOnly$RemoteStartSplit = function (a) {
	return {$: 'RemoteStartSplit', a: a};
};
var $author$project$ViewOnly$decodeRemoteStartSplit = A2(
	$author$project$ViewOnly$checkTag,
	'RemoteControl',
	A2(
		$author$project$ViewOnly$checkTag2,
		...
		A2(
			...
			A2(
				$elm$json$Json$Decode$map,
				$author$project$ViewOnly$RemoteStartSplit,
				A2(
					$elm$json$Json$Decode$at,
					_List_fromArray(
						['data', 'contents', 'contents']),
					$elm$json$Json$Decode$int)))));
var $author$project$ViewOnly$RemoteStop = {$: 'RemoteStop'};
var $author$project$ViewOnly$decodeRemoteStop = A2(
	$author$project$ViewOnly$checkTag,
	'RemoteControl',
	A2(
		$author$project$ViewOnly$checkTag2,
		...
		A2(
			$elm$json$Json$Decode$map,
			$author$project$ViewOnly$SplitsControl,
			$elm$json$Json$Decode$succeed($author$project$ViewOnly$RemoteStop))));
var $author$project$ViewOnly$RemoteUnsplit = {$: 'RemoteUnsplit'};
var $author$project$ViewOnly$decodeRemoteUnsplit = A2(
	$author$project$ViewOnly$checkTag,
	'RemoteControl',
	A2(
		$author$project$ViewOnly$checkTag2,
		...
		A2(
			$elm$json$Json$Decode$map,
			$author$project$ViewOnly$SplitsControl,
			$elm$json$Json$Decode$succeed($author$project$ViewOnly$RemoteUnsplit))));
var $author$project$ViewOnly$splitsControlDecoder = $elm$json$Json$Decode$oneOf(
	_List_fromArray(
		[$author$project$ViewOnly$decodeRemoteStartSplit, $author$project$ViewOnly$decodeRemoteUnsplit, $author$project$ViewOnly$decodeRemoteSkip, $author$project$ViewOnly$decodeRemoteStop, $author$project$ViewOnly$decodeRemoteReset]));
var $author$project$ViewOnly$splitsSpecDecoder = A2(
	$author$project$ViewOnly$checkTag,
	'SplitsRefresh',
	A2(
		$elm$json$Json$Decode$map,
		...
		A4(
			...
			A2(
				...
				_List_fromArray(
					['data', 'contents']),
				$author$project$ViewOnly$runSpecDecoder))));
var $author$project$ViewOnly$processIncomingEvent = $elm$json$Json$Decode$decodeValue(
	$elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[$author$project$ViewOnly$clientStateRequestDecoder, $author$project$ViewOnly$splitsControlDecoder, $author$project$ViewOnly$gameListDecoder, $author$project$ViewOnly$categoryListDecoder, $author$project$ViewOnly$splitsSpecDecoder, $author$project$ViewOnly$multiCategoryDecoder, $author$project$ViewOnly$closeSplitsDecoder, $author$project$ViewOnly$splitsControlDecoder, $author$project$ViewOnly$configStoreDecoder])));
var $author$project$ViewOnly$Reset = function (a) {
	return {$: 'Reset', a: a};
};
var $author$project$ViewOnly$Skip = {$: 'Skip'};
var $author$project$ViewOnly$StartSplit = function (a) {
	return {$: 'StartSplit', a: a};
};
var $author$project$ViewOnly$Stop = {$: 'Stop'};
var $author$project$ViewOnly$Unsplit = {$: 'Unsplit'};
...
var $author$project$ViewOnly$AllRunsViewFade = function (a) {
	return {$: 'AllRunsViewFade', a: a};
};
var $author$project$ViewOnly$AllRunsViewTransition = function (a) {
	return {$: 'AllRunsViewTransition', a: a};
};
var $author$project$ViewOnly$forceCurrentCategoryView = function (model) {
	var _v0 = function ($) {
		return $.timer;
	}(model);
	if (_v0.$ === 'Running') {
		...
		var _v1 = function ($) {
			return $.multiCategoryDisplay;
		}(model);
		switch (_v1.$) {
			case 'CurrentCategoryViewFade':
				var t = _v1.a;
				return _Utils_update(
					model,
					{
						multiCategoryDisplay: $author$project$ViewOnly$AllRunsViewFade(t)
					});
			case 'CurrentCategoryViewTransition':
				var t = _v1.a;
				return _Utils_update(
					model,
					{
						multiCategoryDisplay: $author$project$ViewOnly$AllRunsViewTransition(t)
					});
			case 'AllRunsView':
				return _Utils_update(
					model,
					{
						multiCategoryDisplay: $author$project$ViewOnly$AllRunsViewFade(currentTime)
					});
			default:
				return model;
		}
...
var $author$project$ViewOnly$timerControl = F2(
	function (model, msg) {
		switch (msg.$) {
			case 'StartSplit':
				var t = msg.a;
				...
				switch (_v1.$) {
					case 'Running':
						return _Utils_Tuple2(
							$author$project$ViewOnly$forceCurrentCategoryView(
								_Utils_update(
									model,
									{
										timer: A2(
...
var $author$project$ViewOnly$processSplitsControl = F2(
	function (model, msg) {
		switch (msg.$) {
			case 'RemoteStartSplit':
				var t = msg.a;
				return A2(
					$author$project$ViewOnly$timerControl,
					model,
					$author$project$ViewOnly$StartSplit(
						A2(
							$elm$core$Maybe$map,
							function (time) {
								return $elm$time$Time$millisToPosix(
			...
			case 'RemoteUnsplit':
				return A2($author$project$ViewOnly$timerControl, model, $author$project$ViewOnly$Unsplit);
			case 'RemoteSkip':
				return A2($author$project$ViewOnly$timerControl, model, $author$project$ViewOnly$Skip);
			case 'RemoteStop':
				return A2($author$project$ViewOnly$timerControl, model, $author$project$ViewOnly$Stop);
			default:
				return A2(
					$author$project$ViewOnly$timerControl,
					model,
					$author$project$ViewOnly$Reset(
						function ($) {
							return $.timer;
						}(model)));
		}
...
var $author$project$ViewOnly$send = F2(
	function (ms, v) {
		if (ms.$ === 'Nothing') {
...
var $author$project$ViewOnly$splitsLoadRequestJSON = function (category) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var $author$project$ViewOnly$processData = F2(
	function (model, data) {
		var _v0 = $author$project$ViewOnly$processIncomingEvent(data);
		_v0$6:
		while (true) {
			if (_v0.$ === 'Ok') {
				switch (_v0.a.$) {
					case 'SplitsControl':
						var ctl = _v0.a.a;
						return A2($author$project$ViewOnly$processSplitsControl, model, ctl);
					case 'UnloadSplits':
						var _v1 = _v0.a;
						return _Utils_Tuple2(
							_Utils_update(
					...
					case 'ConfigStoreSet':
						...
						return _Utils_Tuple2(
							...
							A2(
								$author$project$ViewOnly$send,
								function ($) {
									return $.socket;
								}(model),
								$author$project$ViewOnly$splitsLoadRequestJSON(
									A2(
										$elm$core$Maybe$withDefault,
										-1,
...
var $author$project$ViewOnly$AllRunsView = function (a) {
	return {$: 'AllRunsView', a: a};
};
var $author$project$ViewOnly$CurrentCategoryViewFade = function (a) {
	return {$: 'CurrentCategoryViewFade', a: a};
};
var $author$project$ViewOnly$CurrentCategoryViewTransition = function (a) {
	return {$: 'CurrentCategoryViewTransition', a: a};
};
var $author$project$ViewOnly$updateMultiCategoryView = function (model) {
	var timer = function ($) {
		return $.timer;
	}(model);
	var secondsSplits = 300 * 1000;
	var secondsPostFade = 33;
	var secondsFade = 220;
	var secondsAllRuns = 30 * 1000;
	var currentTime = $elm$time$Time$posixToMillis(
	...
	if (timer.$ === 'Running') {
		...
		switch (_v1.$) {
			case 'CurrentCategoryView':
				var t = _v1.a;
				return (_Utils_cmp(currentTime, t + secondsSplits) > 0) ? _Utils_update(
					model,
					{
						multiCategoryDisplay: $author$project$ViewOnly$CurrentCategoryViewFade(currentTime)
					}) : model;
			case 'CurrentCategoryViewFade':
				var t = _v1.a;
				return (_Utils_cmp(currentTime, t + secondsFade) > 0) ? _Utils_update(
					model,
					{
						multiCategoryDisplay: $author$project$ViewOnly$CurrentCategoryViewTransition(currentTime)
					}) : model;
			case 'CurrentCategoryViewTransition':
				var t = _v1.a;
				return (_Utils_cmp(currentTime, t + secondsPostFade) > 0) ? _Utils_update(
					model,
					{
						multiCategoryDisplay: $author$project$ViewOnly$AllRunsView(currentTime)
					}) : model;
			case 'AllRunsView':
				var t = _v1.a;
				return (_Utils_cmp(currentTime, t + secondsAllRuns) > 0) ? _Utils_update(
					model,
					{
						multiCategoryDisplay: $author$project$ViewOnly$AllRunsViewFade(currentTime)
					}) : model;
			case 'AllRunsViewFade':
				var t = _v1.a;
				return (_Utils_cmp(currentTime, t + secondsFade) > 0) ? _Utils_update(
					model,
					{
						multiCategoryDisplay: $author$project$ViewOnly$AllRunsViewTransition(currentTime)
					}) : model;
			default:
				var t = _v1.a;
				return (_Utils_cmp(currentTime, t + secondsPostFade) > 0) ? _Utils_update(
					model,
					{
						multiCategoryDisplay: $author$project$ViewOnly$CurrentCategoryView(currentTime)
					}) : model;
		}
	} else {
		return _Utils_update(
			model,
			{
				multiCategoryDisplay: $author$project$ViewOnly$AllRunsView(0)
			});
	}
};
var $author$project$ViewOnly$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'OpenSocket':
				var url = msg.a;
			...
			case 'SocketOpened':
				...
				return _Utils_Tuple2(
					...
					A2($author$project$Websocket$send, newsocket, $author$project$ViewOnly$newClientJSON));
			case 'SocketNotOpened':
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			case 'SocketReceived':
				var data = msg.a;
				return A2($author$project$ViewOnly$processData, model, data);
			case 'Tick':
				var t = msg.a;
				return _Utils_Tuple2(
					$author$project$ViewOnly$updateMultiCategoryView(
						_Utils_update(
							model,
							{
								timer: A2(
					...
					$elm$core$Platform$Cmd$none);
			case 'StartSplit':
				return A2($author$project$ViewOnly$timerControl, model, msg);
			case 'Reset':
				return A2($author$project$ViewOnly$timerControl, model, msg);
			case 'Unsplit':
				return A2($author$project$ViewOnly$timerControl, model, msg);
...
var $author$project$ViewOnly$showD = F3(
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									_Utils_Tuple2('time-minutes-nolead', true),
									_Utils_Tuple2('time-empty', minutesEmpty)
								]))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									_Utils_Tuple2('time-seconds-nolead', true)
								]))
						]),
					_List_fromArray(
						[
...
var $author$project$ViewOnly$currentSum_ = F2(
	function (split, _v0) {
		var sum = _v0.a;
		var next = A2(
			$elm$core$Maybe$withDefault,
...
var $author$project$ViewOnly$currentSum = function (splits) {
	return A3(
		$elm$core$List$foldl,
		$author$project$ViewOnly$currentSum_,
...
var $author$project$ViewOnly$timeStatus = function (timer) {
	...
	if (_v0.$ === 'Nothing') {
		...
		if (_v1.$ === 'Nothing') {
			...
			if (!_v2.b) {
				...
				var _v3 = $author$project$ViewOnly$currentSum(
					$elm$core$List$reverse(
			...
			var x = _v1.a;
			var _v5 = $author$project$ViewOnly$currentSum(
				_Utils_ap(
					function ($) {
						return $.previous;
					}(s),
...
var $author$project$ViewOnly$Displayable = F5(
...
var $author$project$ViewOnly$unitize = function (t_) {
	...
	return A5($author$project$ViewOnly$Displayable, hours, minutes, seconds, millis, sign);
};
var $author$project$ViewOnly$allCategoriesTimer = function (timer) {
	...
	var runEnded = $elm$time$Time$posixToMillis(
		A2(
			$elm$core$Maybe$withDefault,
			currentTime_,
			function ($) {
	...
	var diffTime = currentTime - runStarted;
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				...
				$elm$html$Html$Attributes$classList(
				$author$project$ViewOnly$timeStatus(timer))
			]),
		_List_fromArray(
			[
				A3(
				$author$project$ViewOnly$showD,
				false,
				_List_Nil,
				$author$project$ViewOnly$unitize(diffTime))
			]));
};
...
var $author$project$Timer$runToSplit = F2(
	function (r, _v0) {
		var pbSum = _v0.a;
		var rs = _v0.b;
		...
		var time = A3(
			...
			F2(
				function (s, e) {
					return $elm$time$Time$millisToPosix(
						$elm$time$Time$posixToMillis(e) - $elm$time$Time$posixToMillis(s));
				}),
			function ($) {
				return $.runStarted;
			}(r),
...
var $author$project$Timer$aggregateAllRuns = F2(
	function (now, rs) {
		var zeroSegment = _Utils_update(
			$author$project$Timer$initSegment,
			{
		...
		var _v0 = A3(
			$elm$core$List$foldl,
			$author$project$Timer$runToSplit,
			_Utils_Tuple2(
		...
		var _v2 = _v1.a;
		var sums1 = _v2.a;
		var pastSegment = _v2.b;
		var runningTotalsP = _v1.b;
		var _v3 = A3(
			$elm$core$List$foldl,
			$author$project$Timer$runToSplit,
			_Utils_Tuple2(t1, _List_Nil),
			function () {
				var _v4 = function ($) {
					return $.current;
				}(rs);
		...
		var _v5 = A3(
			...
			_Utils_Tuple2(
				...
				_List_Nil),
			current);
		var currentSegment = _v5.a;
		var runningTotalC_ = _v5.b;
...
var $author$project$ViewOnly$splitHeaders = _List_fromArray(
	[
		A2(
		$elm$html$Html$div,
		_List_fromArray(
...
var $author$project$ViewOnly$diffDatum = function (d) {
	var sdiff = F3(
		function (seg, f, g) {
			var _v0 = f(seg);
			if (_v0.$ === 'Nothing') {
...
var $author$project$ViewOnly$splitSegment = F3(
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						showSign,
						_List_Nil,
						$author$project$ViewOnly$unitize(t))
					]));
		}
	});
var $author$project$ViewOnly$aggregateData = F2(
	function (_v0, _v2) {
		var i = _v0.a;
		var _v1 = _v0.b;
		var tag = _v1.a;
		...
		var diff = $author$project$ViewOnly$diffDatum(timing);
		var div = A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					A3(
					$author$project$ViewOnly$splitSegment,
					false,
					_List_fromArray(
						['pb']),
					function ($) {
...
var $author$project$ViewOnly$splitsList_ = F2(
	function (max, timing) {
		var f = function (s) {
		...
		var _v0 = A3(
			$elm$core$List$foldl,
			$author$project$ViewOnly$aggregateData,
			_Utils_Tuple2(0, _List_Nil),
			data);
		var divs = _v0.b;
		return divs;
	});
var $author$project$ViewOnly$categoriesList = F2(
	function (max, splits) {
		var currentTime = function (r) {
		...
		if (_v0.$ === 'SingleCategory') {
			...
			return A2(
				...
				_Utils_ap(
					$author$project$ViewOnly$splitHeaders,
					A2(
						$author$project$ViewOnly$splitsList_,
						max,
						A2(
							$author$project$Timer$aggregateRun,
							currentTime(
								function ($) {
									return $.runStarted;
								}(r)),
			...
			return A2(
				...
				_Utils_ap(
					...
					A2(
						...
						max,
						A2(
							$author$project$Timer$aggregateAllRuns,
							currentTime(
								function ($) {
									return $.runStarted;
								}(splits)),
...
var $author$project$ViewOnly$allCategoriesTimerView = F4(
	function (visible, splits, max, timer) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple2('timer-container', true),
							_Utils_Tuple2('hidden', !visible)
						]))
				]),
			_List_fromArray(
				[
					...
					A2($author$project$ViewOnly$categoriesList, max, splits),
					$author$project$ViewOnly$allCategoriesTimer(timer)
				]));
	});
var $author$project$ViewOnly$categoryTimer = function (timer) {
	var splits = $author$project$Timer$splitsFor(timer);
	var currentTime_ = function ($) {
		return $.currentTime;
	}(splits);
...
var $author$project$ViewOnly$splitsList = F2(
	function (max, splits) {
		var currentTime = function (r) {
			return $elm$time$Time$posixToMillis(
				A2(
			...
			return A2(
				...
				_Utils_ap(
					...
					A2(
						...
						$author$project$ViewOnly$splitsList_(max),
						A2(
							$elm$core$List$map,
							function (r) {
								return A2(
...
var $author$project$ViewOnly$singleTimerView = F4(
	function (visible, splits, max, timer) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
			...
			_List_fromArray(
				[
					...
					A2($author$project$ViewOnly$splitsList, max, splits),
					$author$project$ViewOnly$categoryTimer(timer)
				]));
	});
var $author$project$ViewOnly$timerViewNormal = F3(
	function (mcd, max, timer) {
		var splits = $author$project$Timer$splitsFor(timer);
		var singleView = function (b) {
			return A4($author$project$ViewOnly$singleTimerView, b, splits, max, timer);
		};
		var _v0 = function ($) {
			return $.runTracker;
		}(splits);
		if (_v0.$ === 'SingleCategory') {
			...
			var rs = _v0.a;
			var multiView = function (b) {
				return A4($author$project$ViewOnly$allCategoriesTimerView, b, splits, max, timer);
			};
			var _v1 = A2(
				$elm$core$Maybe$map,
				function ($) {
...
var $author$project$ViewOnly$timerView = function (model) {
	return A3(
		$author$project$ViewOnly$timerViewNormal,
		function ($) {
			return $.multiCategoryDisplay;
		}(model),
		function ($) {
...
var $author$project$ViewOnly$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$ViewOnly$timerView(model)
					]))
			]));
};
var $author$project$ViewOnly$main = $elm$browser$Browser$element(
	{init: $author$project$ViewOnly$init, subscriptions: $author$project$ViewOnly$subscriptions, update: $author$project$ViewOnly$update, view: $author$project$ViewOnly$view});
_Platform_export({'ViewOnly':{'init':$author$project$ViewOnly$main($elm$json$Json$Decode$string)(0)}});}(this));