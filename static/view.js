...
var $author$project$Timer$emptySplitSet = {
	...
	upcoming: _List_fromArray(
		[
			{endTime: $elm$core$Maybe$Nothing, segment: $author$project$Timer$emptySegment}
		])
};
...
var $author$project$ViewOnly$init = function (url) {
	return _Utils_Tuple2(
		{categoryList: _List_Nil, configStore: $elm$core$Dict$empty, gameList: _List_Nil, maxSegmentsShown: 10, socket: $elm$core$Maybe$Nothing, timer: $author$project$Timer$empty},
...
var $author$project$Timer$loadRun = function (runSpec) {
	if (runSpec.$ === 'SingleCategorySpec') {
		...
		return $author$project$Timer$SingleCategory(segments);
	} else {
		var segments = runSpec.a;
		return $author$project$Timer$MultiCategory(
			{current: $elm$core$Maybe$Nothing, previous: _List_Nil, upcoming: segments});
	}
};
...
var $author$project$Timer$Split = F2(
	function (segment, endTime) {
		return {endTime: endTime, segment: segment};
	});
...
var $author$project$ViewOnly$splitSetDecoder = A2(
	...
	$elm$json$Json$Decode$list(
		A2(
			$elm$json$Json$Decode$map,
			function (s) {
				return A2($author$project$Timer$Split, s, $elm$core$Maybe$Nothing);
			},
			A8(
				...
				A2(
					...
					'segmentWorst',
					$elm$json$Json$Decode$maybe($elm$json$Json$Decode$int))))));
var $author$project$ViewOnly$runSpecDecoder = A2(
	$elm$json$Json$Decode$map,
	$author$project$Timer$SingleCategorySpec,
	A4(
		$elm$json$Json$Decode$map3,
...
var $author$project$ViewOnly$processIncomingEvent = $elm$json$Json$Decode$decodeValue(
	$elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[$author$project$ViewOnly$clientStateRequestDecoder, $author$project$ViewOnly$splitsControlDecoder, $author$project$ViewOnly$gameListDecoder, $author$project$ViewOnly$categoryListDecoder, $author$project$ViewOnly$splitsSpecDecoder, $author$project$ViewOnly$closeSplitsDecoder, $author$project$ViewOnly$splitsControlDecoder, $author$project$ViewOnly$configStoreDecoder])));
		...
		if (t.$ === 'Running') {
			...
			if (_v1.$ === 'SingleCategory') {
				var newt = A2(
					...
					$author$project$Timer$split_)(currentTime)(t);
...
var $author$project$ViewOnly$mainTimer = function (timer) {
...
var $author$project$Timer$aggregateRun_ = F3(
	function (now, currentSplit, _v0) {
		...
		return _Utils_Tuple2(
			_Utils_Tuple2(nextSegment, nextTime),
			_Utils_ap(
				segs,
				_List_fromArray(
					[
						{currentSum: currentTime, running: seg, segment: indiv, singleTime: singleTime, timingTags: tags}
					])));
	});
...
var $author$project$Timer$aggregateRun = F2(
	function (now, r) {
		...
		var _v0 = A3(
			...
			previous);
		var _v1 = _v0.a;
		var pastSegment = _v1.a;
		var runningTotalsP = _v0.b;
		var _v2 = A3(
			$elm$core$List$foldl,
			$author$project$Timer$aggregateRun_(now),
			_Utils_Tuple2(
				_Utils_Tuple2(pastSegment, $elm$core$Maybe$Nothing),
				_List_Nil),
			current);
...
var $author$project$ViewOnly$timerViewNormal = F2(
	function (max, timer) {
		var splits = $author$project$Timer$splitsFor(timer);
		return A2(
			$elm$html$Html$div,
			...
			_List_fromArray(
				[
					...
					$author$project$ViewOnly$mainTimer(timer)
				]));
	});
